...
public class ListSimple {
    ...
    NodListSimple inicio; // Crea el puntero que apunta a la lista
    ...
    public void InsertaInicio(int dato) {
        NodListSimple n = new NodListSimple(dato); // Crea el nodo apuntado por el puntero n
